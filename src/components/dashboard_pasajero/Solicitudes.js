...
function createData(nombre, carro, origen, destino, precio) {
  return { nombre, carro, origen, destino, precio };
}
...
const headCells = [
  { id: 'nombre', numeric: false, disablePadding: true, label: 'Nombre Conductor' },
  { id: 'carro', numeric: true, disablePadding: false, label: 'Carro' },
  { id: 'origen', numeric: true, disablePadding: false, label: 'Origen' },
...
export default function EnhancedTable() {
  ...
  const [orderBy, setOrderBy] = React.useState('carro');
